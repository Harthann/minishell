...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/05/30 16:13:32 by user42            #+#    #+#             */
/*   Updated: 2020/05/30 16:18:13 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	**clean_loop(char **av, char *params, t_env_lst *lst, t_data *data)
{
	int j;
	int	index;
...
char	**clean_params(char *params, t_env_lst *lst, t_data *data)
{
	...
	if (!(av = ft_calloc((c_p(params) + 1), sizeof(char *))))
		return (NULL);
	return (clean_loop(av, params, lst, data));
}
